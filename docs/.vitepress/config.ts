...
export default defineConfig({
  ...
  themeConfig: {
    ...
    sidebar: {
      "/open_source/": getSidebar({ contentRoot: '/docs/', contentDirs: ['open_source'], collapsible: false, collapsed: false }),
      "/blogs/": getSidebar({ contentRoot: '/docs/', contentDirs: ['blogs'], collapsible: false, collapsed: false}),
      "/tutorials/": getSidebar({ contentRoot: '/docs/', contentDirs: ['tutorials'], collapsible: false, collapsed: false }),
    },

    socialLinks: [
      { icon: 'github', link: 'https://github.com/ARTINX' },
      {
        icon: {
        ...
        link: 'https://space.bilibili.com/645940972',
      }
    ],
